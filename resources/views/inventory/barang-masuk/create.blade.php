            ...
            <tbody>
                ...
                @forelse(
                    ...
                    <tr>
                        ...
                        <td>
                            {{ $barangMasuk->nama_barang_spesifikasi }}
                        </td>
                        ...
                        <td>
                            ...
                            <div class="inventory-actions-cell">
                                ...
                                @php
                                    $_bmCanEdit = \App\Support\DepartmentAccess::canEditBarang(auth()->user(), $barangMasuk->barang);
                                    $_bmCanDelete = \App\Support\DepartmentAccess::canDeleteBarang(auth()->user(), $barangMasuk->barang);
                                @endphp
        ...
        >
            ...
            <div class="inventory-modal-body">
                ...
                <div class="inventory-form-grid">
                    ...
                    <div class="inventory-form-group inventory-form-full">
                        ...
                        <div class="inventory-search-row">
                            ...
                            <input
                                type="text"
                                name="nama_barang_spesifikasi"
                                id="nama_barang_spesifikasi"
                                class="inventory-form-control"
                                value="{{ old('nama_barang_spesifikasi') }}"
