...
<div class="container">
    ...
    <div class="header">
        ...
        <div class="header-actions no-print">
            ...
            <a
                ...
                class="btn btn-edit"
                style="background:var(--pds-line);color:var(--pds-ink-2);"
            >
                Kembali
            </a>

            @if($viewerIsAdmin || $viewerOwnsWo)

                <a
                    href="{{ route('work-orders.edit', $workOrder->id) }}"
                    class="btn btn-edit"
                >
                    <x-icon name="edit"></x-icon> Edit Permintaan
                </a>
    ...
    <div class="monitoring-notice no-print">

        <strong>Mode Monitoring User.</strong>

        Anda hanya dapat melihat perkembangan Work Order dan
        mengubah data permintaan Work Order milik Anda sendiri.
        Data tindak lanjut Maintenance bersifat
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h2>
                Detail Permintaan Work Order
            </h2>

            <p>
                Data yang dibuat oleh User
            </p>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <p>
                Perkembangan permintaan dari awal sampai selesai
            </p>
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <p>
                Informasi tindak lanjut yang diberikan Maintenance
            </p>
